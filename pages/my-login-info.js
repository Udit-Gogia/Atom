...
import { IconEdit, IconArrow } from "../assets/images";
import {
  getUserDataFromApi,
  updatePassword,
...
export default function MyLoginInfo() {
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-100 overflow-x-hidden ">
      <div className="flex flex-col border-2 sm:p-4 lg:p-2 sm:mx-4 md:mx-auto mb-12 rounded-lg md:w-5/12 mt-2 lg:px-2 h-fit gap-4 bg-white overflow-x-hidden">
        ...
        <div className={`mx-4 mb-4 px-4 ${editUsername ? "hidden" : "inline"}`}>
          ...
          {/* new password */}
          <div
            className={`mx-4 px-4 $ ${editPassword ? "inline " : "hidden "}`}
          >
